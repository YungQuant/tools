...
Din = 30
X, Y = create_nerfed_agg_ohlcv_dataset(ps, Din, curr=0, ohlcv=1)
print("X0:\n", X[0])
print("shape(X):", X.shape)
X1, Y1 = create_nerfed_agg_ohlcv_dataset(ps1, Din, curr=0, ohlcv=1)
print("X10:\n", X1[0])
...
reduce_lr = ReduceLROnPlateau(monitor='val_loss', factor=0.99, patience=5, min_lr=0.000001)
opt = keras.optimizers.Adam(lr=0.0001, epsilon=42, decay=0.0001, amsgrad=False)
