...
from coinbene import create_buy_order, get_orderbook, cancel_all_orders
...
while(1):
    try:
        ...
        print("Coinbene RandBuyAsk Version 1 -hugo")
        ...
        if t > T:
            ...
            print(create_buy_order(ticker, str(ask), str(np.random.uniform(s1, s2))[:6]))
            quantity -= aVol
